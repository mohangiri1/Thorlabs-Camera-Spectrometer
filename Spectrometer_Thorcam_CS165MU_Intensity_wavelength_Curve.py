...
#---------------------------------Calibration of wavelength-----------------------------------------------------------
            ...
            #Insert at least three known pixel wavelength relation from the calibration.
            pixel =      [0, 574, 1439]
            wavelength = [450, 488, 528.069269053368]
            
            # Finding out the coefficients using polyplot.
